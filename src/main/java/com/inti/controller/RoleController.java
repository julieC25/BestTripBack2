...
public class RoleController {
	...
	public void delete(@PathVariable("idRole") Long id) {
	...
	@PatchMapping("/roles/{idRole}/libelle")
	public Role updateRoleLibelle(@PathVariable("idRole") Long id,@RequestBody Role role) {
		Role currentRole = roleService.findOne(id);
		currentRole.setLibelle(role.getLibelle());
		return roleService.save(currentRole);
	}
